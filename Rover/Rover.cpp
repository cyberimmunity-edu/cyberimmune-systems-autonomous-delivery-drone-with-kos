...
#endif
    SCHED_TASK_CLASS(KOS_InteractionModule, &rover.kos_interaction, receive_KOS_message, 5, 100, 200),
#if AP_SIM_ENABLED
    SCHED_TASK_CLASS(KOS_HardwareSimulation, &rover.kos_hardware_simulation, send_sensor_data, 10, 100, 200),
    SCHED_TASK_CLASS(KOS_HardwareSimulation, &rover.kos_hardware_simulation, receive_periphery_data, 5, 100, 200),
#endif
};
