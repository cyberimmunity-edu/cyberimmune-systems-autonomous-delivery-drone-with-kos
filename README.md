...
===========================================================================
### [Используемый способ запуска цифрового двойника при помощи docker контейнеров и docker-compose](DEVELOPMENT.md#способ-2-запуск-цифрового-двойника-в-ubuntu-2204-без-docker-контейнеров)
### Результаты
