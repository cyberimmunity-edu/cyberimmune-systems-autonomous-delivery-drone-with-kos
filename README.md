...
===========================================================================
### [Используемый способ запуска цифрового двойника при помощи docker контейнеров и docker-compose](https://github.com/aivx/cyberimmune-systems-autonomous-delivery-drone-with-kos/blob/main/docs/DEVELOPMENT.md#способ-1-запуск-цифрового-двойника-при-помощи-docker-контейнеров-и-docker-compose)
