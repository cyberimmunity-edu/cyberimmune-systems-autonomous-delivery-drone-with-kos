 ...
 * \return Returns 1 on successful coordinates receive the GNSS module, 0 otherwise.
 ...
 * \return Возвращает 1, если координаты были успешно получены от модуля GNSS, иначе -- 0.
 */
 ...
 * \return Returns 1 on successful information receive the GNSS module, 0 otherwise.
 ...
 * \return Возвращает 1, если информация была успешно получена от модуля GNSS, иначе -- 0.
 */
