...
int requestServer(char* query, char* response, uint32_t responseSize) {
    if (strstr(query, "/api/kill_switch?") != NULL) {
        ...
        strncpy(response, "$ForbiddenZones 1&test_area&7&53.1021169_107.3777130&53.1022184_107.3779973&53.1022023_107.3783299&53.1020767_107.3784882&53.1019962_107.3782709&53.1019189_107.3779812&53.1019656_107.3777157#", 192);
    }
    else {
        if (responseSize < 3) {
            logEntry("Size of response does not fit given buffer", ENTITY_NAME, LogLevel::LOG_WARNING);
